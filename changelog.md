...
- Added the `cai_causal_graph.graph_components.Node.is_input` and `cai_causal_graph.graph_components.Node.is_output`
  methods to the `cai_causal_graph.graph_components.Node`, indicating whether the node is a source node or sink node
  respectively.
