...
- `cai_causal_graph.time_series_causal_graph.TimeSeriesCausalGraph.get_minimal_graph` will now always return a graph of the
  same class type as the current graph instance.
