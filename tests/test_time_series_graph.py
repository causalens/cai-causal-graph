...
class TestCausalGraphEdgeTypes(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.ground_truth_summary_graph.add_edge(
            "X1", "X2", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_summary_graph.add_edge(
            "X1", "X3", edge_type=EDGE_T.DIRECTED_EDGE
        )
        ...
        self.dag_1.add_edge(
            "X1 lag(n=2)", "X1 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        # X2
        self.dag_1.add_edge("X2 lag(n=1)", "X2", edge_type=EDGE_T.DIRECTED_EDGE)
        self.dag_1.add_edge(
            "X2 lag(n=2)", "X2 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        # X3
        self.dag_1.add_edge("X3 lag(n=1)", "X3", edge_type=EDGE_T.DIRECTED_EDGE)
        self.dag_1.add_edge(
            "X3 lag(n=2)", "X3 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        ...
        self.ground_truth_summary_graph_1.add_edge(
            "X3", "X1", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_summary_graph_1.add_edge(
            "X3", "X2", edge_type=EDGE_T.DIRECTED_EDGE
        )
        ...
        self.ground_truth_minimum_graph_1.add_edge(
            "X3", "X1", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_minimum_graph_1.add_edge(
            "X1 lag(n=1)", "X1", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_minimum_graph_1.add_edge(
            "X2 lag(n=1)", "X2", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_minimum_graph_1.add_edge(
            "X3 lag(n=1)", "X3", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_minimum_graph_1.add_edge(
            "X3 lag(n=1)", "X1", edge_type=EDGE_T.DIRECTED_EDGE
        )
        self.ground_truth_minimum_graph_1.add_edge(
            "X3 lag(n=2)", "X2", edge_type=EDGE_T.DIRECTED_EDGE
        )

    def test_extract_names_and_lags(self):
        nodes, maxlag = extract_names_and_lags(self.nodes)
        self.assertEqual(
            nodes, [{"X1": 1}, {"X2": 1}, {"X3": 1}, {"X1": 0}, {"X2": 0}, {"X3": 0}]
        )
        assert maxlag == 1
    ...
    def test_from_adjacency_matrix(self):
        ...
        tsdag = TimeSeriesCausalGraph.from_adjacency_matrix(
            mg.adjacency_matrix, mg.get_node_names()
        )
    ...
    def test_from_adjacency_matrices(self):
        ...
        variables = ["X1", "X2", "X3"]
        tsdag = TimeSeriesCausalGraph.from_adjacency_matrices(
            {0: adj_mat_lag_0, 1: adj_mat_lag_1}, variables
        )
        self.assertEqual(tsdag, mg)
    ...
    def test_extend_backward(self):
        ...
        extended_graph.add_edge(
            "X1 lag(n=2)", "X2 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph.add_edge(
            "X1 lag(n=1)", "X3 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        ...
        extended_graph_1.add_edge(
            "X3 lag(n=2)", "X1 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph_1.add_edge(
            "X3 lag(n=1)", "X1 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph_1.add_edge(
            "X3 lag(n=3)", "X2 lag(n=1)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        ...
        extended_graph.add_edge(
            "X1 lag(n=3)", "X1 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph.add_edge(
            "X2 lag(n=3)", "X2 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph.add_edge(
            "X3 lag(n=3)", "X3 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph.add_edge(
            "X1 lag(n=3)", "X2 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph.add_edge(
            "X1 lag(n=2)", "X3 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph._update_meta_from_node_names()
        ...
        # create the extended graph from the previous extended graph
        extended_graph_1.add_edge(
            "X3 lag(n=4)", "X2 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph_1.add_edge(
            "X3 lag(n=3)", "X1 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph_1.add_edge(
            "X3 lag(n=3)", "X3 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph_1.add_edge(
            "X3 lag(n=2)", "X1 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
        extended_graph_1.add_edge(
            "X1 lag(n=3)", "X1 lag(n=2)", edge_type=EDGE_T.DIRECTED_EDGE
        )
